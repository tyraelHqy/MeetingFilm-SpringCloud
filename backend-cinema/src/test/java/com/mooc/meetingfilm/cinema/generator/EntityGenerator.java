...
public class EntityGenerator {
    ...
    private String outputDir = "/Users/leohuang/SynologyDrive/LeoHPLaptop/IdeaProjects/backend-parent/backend-cinema/src/main/java";
    // 生成类的作者
    private String author = "tyrael";
    // 数据源相关配置
